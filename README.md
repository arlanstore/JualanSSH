...
Mod By http://arlanstore.epizy.com
...
rm -f setup.sh && apt update && apt upgrade -y && update-grub && sleep 2 && apt-get update -y && apt-get upgrade && sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/arlanstore/JualanSSH/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
...
<a href="wa group
https://chat.whatsapp.com/HtEmxuTK9DBLHhHokJ8hVIimages/embed/trbtn-red-6.png" height="40" style="border: 0px; height: 40px;" alt="Trakteer Saya"></a>

wa group
https://chat.whatsapp.com/HtEmxuTK9DBLHhHokJ8hVI
...
<img height=21 src="http://arlanstore.epizy.com">
...
<a href="http://arlanstore.epizy.com" height='50'> </a>
...
<img height=150 src="https://github-readme-stats.vercel.app/api/top-langs/?username=arlanstore&layout=compact&theme=dark">

<img height=150 src="https://github-readme-stats.vercel.app/api?username=arlanstore&count_private=true&show_icons=true&theme=dark">
